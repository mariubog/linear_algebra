...
public class Vector_Calculations {
	...
	public Vector calculateUnitVector(Vector v, int precision) throws IllegalArgumentException {
		Vector u = null;
	...
	public double calculateCrossProduct(Vector v1, Vector v2) throws DiffernetDimentionsVectorException {
		double k = 0.00;
		if (v1 != null && v2 != null) {
			if (v1.getCoordinates().length != v2.getCoordinates().length) {
				throw new DiffernetDimentionsVectorException();
	...
	public boolean areVectorsParallel(Vector v1, Vector v2) {
	...
	public boolean checkParallelWithDotProductZeroAngle(Vector v1, Vector v2) {
	...
	public boolean checkParallelWithUnitvector(Vector v1, Vector v2) {
...
//			System.out.println("U1: " + uv1);
//			System.out.println("U2: " + uv2);
//			System.out.println("-U2: " + multiplyVectorsByScalar(uv2, -1));
